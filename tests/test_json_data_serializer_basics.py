...
@pytest.mark.parametrize('json_data_serializer',
                         [Mode.OFF, Mode.DRAFT3, Mode.DRAFT4],
...
@pytest.mark.parametrize(
    'validator,file_list',
    [
        (Mode.OFF, ['draft3.json']),
        (Mode.DRAFT3, ['draft3.json']),
        (Mode.DRAFT4, ['draft4.json'])
    ]
)
def test_advanced_create_and_check(fixture_folder, json_basic, validator,
    ...
    serializer = JSONDataSerializer(
        ...
        no_sub_data=True, file_list=file_list,
        validator=validator
    )
