...
from jsondata.JSONDataSerializer import MODE_SCHEMA_DRAFT4,BRANCH_REPLACE
...
class CallUnits(unittest.TestCase):
    """Base branch import by branch_replace.
    """
    ...
    def testCase000(self):
        ...
        kargs['branchoperations'] = BRANCH_REPLACE
    ...
    def testCase100(self):
        ...
        print repr({u'phoneNumber':configdata.data['phoneNumber']})
        print conf_dat
        assert repr({u'phoneNumber':configdata.data['phoneNumber']}) == conf_dat
        pass
