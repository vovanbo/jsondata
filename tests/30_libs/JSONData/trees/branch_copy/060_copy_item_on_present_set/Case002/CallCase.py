...
#
    ...
    def testCase110(self):
        ...
        ret = configdata.branch_copy(target['phoneNumber'][0], None, branchdata['phoneNumber'][0])
        assert ret == True 
        conf_dat = repr(configdata.data)
    ...
    def testCase111(self):
        ...
        ret = configdata.branch_copy(target['phoneNumber'][1], None, branchdata['phoneNumber'][0])
        assert ret == True 
        conf_dat = repr(configdata.data)
    ...
    def testCase112(self):
        ...
        ret = configdata.branch_copy(target['phoneNumber'][2], None, branchdata['phoneNumber'][0])
        assert ret == True 
        conf_dat = repr(configdata.data)
