...
class CallUnits(unittest.TestCase):
    ...
    def testCase100(self):
        ...
        try:
            ret = configdata.branch_move(target['phoneNumber'], 0, branchdata['phoneNumber'], 0, False)
...
#
    ...
    def testCase110(self):
        ...
        b_dat = """{u'phoneNumber': [{u'type': u'home', u'number': u'111 222-333'}]}"""
        ...
        ret = configdata.branch_move(target['phoneNumber'], 0, branchdata['phoneNumber'], 0)
        assert ret == True 
        conf_dat = repr(configdata.data)
