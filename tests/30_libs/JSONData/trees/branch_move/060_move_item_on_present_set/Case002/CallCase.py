...
class CallUnits(unittest.TestCase):
    ...
    def testCase100(self):
        ...
        try:
            ret = configdata.branch_move(target, None, branchdata, None, False)
...
#
    ...
    def testCase110(self):
        ...
        try:
            ret = configdata.branch_move(target['phoneNumber'], None, branchdata['phoneNumber'], 0, False)
    ...
    def testCase111(self):
        ...
        ret = configdata.branch_move(target['phoneNumber'], 1, branchdata['phoneNumber'], 0)
        assert ret == True 
        conf_dat = repr(configdata.data)
        conf_dat = """{u'phoneNumber': [{u'type': u'home', u'number': u'212 555-1234'}, {u'type': u'home', u'number': u'111 222-333'}, {u'type': u'mobile', u'number': u'777 666-555'}], u'address': {u'city': u'New York', u'streetAddress': u'21 2nd Street', u'houseNumber': 12}}"""
        assert repr(configdata.data) == conf_dat
        pass
    ...
    def testCase112(self):
        ...
        target = configdata.data
        tconf = """{u'phoneNumber': [{u'type': u'home', u'number': u'212 555-1234'}, {u'type': u'home', u'number': u'111 222-333'}, {u'type': u'mobile', u'number': u'777 666-555'}], u'address': {u'city': u'New York', u'streetAddress': u'21 2nd Street', u'houseNumber': 12}}"""
        assert repr(target) == tconf
        
        ret = configdata.branch_move(target['phoneNumber'], 2, branchdata['phoneNumber'], 0)
        assert ret == True 
        conf_dat = repr(configdata.data)
        conf_dat = """{u'phoneNumber': [{u'type': u'home', u'number': u'212 555-1234'}, {u'type': u'home', u'number': u'111 222-333'}, {u'type': u'home', u'number': u'111 222-333'}], u'address': {u'city': u'New York', u'streetAddress': u'21 2nd Street', u'houseNumber': 12}}"""
        assert repr(configdata.data) == conf_dat
        pass
