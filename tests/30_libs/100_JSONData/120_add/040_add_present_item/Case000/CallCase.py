...
class CallUnits(unittest.TestCase):
    ...
    def testCase100(self):
        ...
        configdata.branch_add(target['phoneNumber'], 0, branchdata)
        conf_dat = repr(configdata.data)
        conf_dat = """{u'phoneNumber': [{u'phoneNumber': [{u'type': u'home', u'number': u'111 222-333'}]}, {u'type': u'office', u'number': u'313 444-555'}, {u'type': u'mobile', u'number': u'777 666-555'}], u'address': {u'city': u'New York', u'streetAddress': u'21 2nd Street', u'houseNumber': 12}}"""
