"""Simple print data read from 'sourcefile'.
"""
...
class CallUnits(unittest.TestCase):
    ...
    def testCase950(self):
        ...
        kwargs = {'sourcefile':os.path.dirname(__file__)+os.sep+"testdata.json" }
        configdata.print_data(False, **kwargs)
        sout = sys.stdout.getvalue()
        sys.stdout = oout
        conf_out = """{"phoneNumber": [{"type": "home", "number": "212 555-1234"}], "address": {"city": "New York", "streetAddress": "21 2nd Street", "houseNumber": 12}}
"""
#         print "sout<"+sout+">"
