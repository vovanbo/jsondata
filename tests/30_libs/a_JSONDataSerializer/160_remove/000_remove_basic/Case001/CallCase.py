...
class CallUnits(unittest.TestCase):
    ...
    def testCase100(self):
        ...
        ret = configdata.branch_remove(target['phoneNumber'], None)
        assert ret == True

        conf_dat = repr(configdata.data)
        conf_dat = "{u'phoneNumber': [], u'address': {u'city': u'New York', u'streetAddress': u'21 2nd Street', u'houseNumber': 12}}"
