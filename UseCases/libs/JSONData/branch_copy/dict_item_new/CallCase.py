...
class CallUnits(unittest.TestCase):
    ...
    def testCase500(self):
        ...
        # target container
#         target = configdata.data['phoneNumber']
        target = configdata['phoneNumber'][0]

        ret = configdata.branch_copy(target, 'newitem', branchdata['phoneNumber'][0]['type'])
        assert ret == True

        conf_dat = repr(configdata.data)
        conf_dat = """{u'phoneNumber': [{'newitem': u'home', u'type': u'home', u'number': u'212 555-1234'}, {u'type': u'office', u'number': u'313 444-555'}, {u'type': u'mobile', u'number': u'777 666-555'}], u'address': {u'city': u'New York', u'streetAddress': u'21 2nd Street', u'houseNumber': 12}}"""
