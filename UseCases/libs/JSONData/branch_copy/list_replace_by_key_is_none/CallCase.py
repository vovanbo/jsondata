...
class CallUnits(unittest.TestCase):
    ...
    def testCase500(self):
        ...
        # branch to be added
        datafile = os.path.abspath(os.path.dirname(__file__))+os.sep+str('branch3.json')
        ...
        assert repr(branchdata.data) == """[{u'type': u'home', u'number': u'111 222-333'}]"""
...
#         target = configdata.data['phoneNumber']
        ...
        ret = configdata.branch_copy(target, None, branchdata.data)
        assert ret == True
