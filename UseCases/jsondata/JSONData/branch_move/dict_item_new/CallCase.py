...
class CallUnits(unittest.TestCase):
    ...
    def testCase500(self):
        ...
        assert branchdata.data == {u'phoneNumber': [{u'type': u'home', u'number': u'111 222-333'}]}


        # target container
        target = configdata
        ret = configdata.branch_move(target.data, 'newitem', branchdata.data,'phoneNumber')
        assert ret == True

        conf_dat = repr(configdata.data)
        conf_dat = """{'newitem': [{u'type': u'home', u'number': u'111 222-333'}], u'phoneNumber': [{u'type': u'home', u'number': u'212 555-1234'}, {u'type': u'office', u'number': u'313 444-555'}, {u'type': u'mobile', u'number': u'777 666-555'}], u'address': {u'city': u'New York', u'streetAddress': u'21 2nd Street', u'houseNumber': 12}}"""
