...
A blueprint and help for the beginning.
...
* draft_fge_json_schema_validation_00: JSONschema validation.

* draft_luff_json_hyper_schema_00: JSONschema validation.

* draft_zyp_json_schema_04: JSONschema validation.
